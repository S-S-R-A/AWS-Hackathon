...
def user_prompting_bedrock(user_question, kvs_string) -> str:
    model_id = 'mistral.mixtral-8x7b-instruct-v0:1'
    response_body = generate_bedrock_response_text(model_id, kvs_string, user_question)
    return response_body['text']

def generate_bedrock_response_text(model_id, kvs_string, user_question):
